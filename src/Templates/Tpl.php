...
namespace U0mo5\Tools\Templates;
 ...
 */
    public static  function pageAssignAction($page_size = 20, $num = 0, $condition = '')
    {
        //翻页
        //每页显示的条数
        ...
        if ($num > $page_size) {
        // $this->assign('page', $subPages->pageShow());    //done   页面引擎 修改为输出arr
        $out['page']=$subPages->pageShow();
        }
