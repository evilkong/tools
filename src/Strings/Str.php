 ...
 */
    ...
    public static  function setcookie_header($name, $value='', $maxage=0, $path='', $domain='', $secure=false, $HTTPOnly=false)
    {
        if (!empty($domain)) {
...
//
    ...
    public static  function errorHandler($err_type, $errstr, $errfile, $errline)
    {
    ...
    public static  function show_tips($message, $url= '', $time = 3)
    {
        ob_get_clean();
...
END;
     ...
     */
    public static  function show_json($data, $code = true, $info='', $url='')
    {
     ...
     */
    public static  function getTplList($cute1, $cute2, $arraylist, $tpl, $current, $current_str='')
    {
...
//
    ...
    */
    ...
    public static  function contains_string($haystack, $needles)
    {
    ...
    public static  function sub_str($string, $start, $length = null)
    {
     ...
     */
    public static  function str_number($str)
    {
