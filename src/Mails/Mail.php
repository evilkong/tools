...
class Mail
{
     ...
     *
     * try{
     * $users = array('987654321@qq.com','admin@bookfuns.com');
     * $title = '测试标题';
     * $content = '测试邮箱内容！';
     ...
     *
     */
    public static  function sendMail(array $to, $title, $content)
    {
        ...
        'MAIL_HOSTNAME'  =>  'http://163.com',   // 设置发件人的主机域
        'MAIL_PORT'      =>  994,  //设置ssl连接smtp服务器的远程服务器端口号 可选465或587
        'MAIL_SMTPAUTH'  =>  true, //启用smtp认证
        'MAIL_USERNAME'  =>  '12345678@163.com',  // 用户名
        'MAIL_FROM'      =>  '12345678@163.com',  // 邮箱地址
        'MAIL_FROMNAME'  =>  'admin',  // 发件人姓名
        'MAIL_PASSWORD'  =>  '12345678',  //smtp登录的密码 使用生成的授权码
        'MAIL_CHARSET'   =>  'UTF-8',   // 字符集
        'MAIL_ISHTML'    =>  true, // 是否HTML格式邮件
        'MAIL_REPLYTO'   =>  '12345678@163.com',   //用户回复邮件时的接收邮箱，可以与原始邮箱分开
