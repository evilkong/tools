 ...
 * Date: 2015/9/30
 * Time: 13:36
 * T\Arrays\Arr::getCol($array, $field);
 */
 ...
 */
     ...
     * @return array
     */
    public static function addCol($array, $field, $value="")
    {
        if (!is_array($array) || count($array) < 1) {
            return array();
        }
     ...
     * @return array
     */
    public static function findCol($array, $field, $value="")
    {
        if (!is_array($array) || count($array) < 1) {
            return array();
        }
     ...
     * @return array
     */
    public static function removeNullCol($array)
    {
        if (!is_array($array) || count($array) < 1) {
            return array();
        }
     ...
     * @return array
     */
    public static function filterArray($arr, $fields)
    {
        $out=array();
    ...
    // 取出数组中第n项
    public static  function array_get_index($arr, $index)
    {
        foreach ($arr as $k=>$v) {
            $index--;
            if ($index<0) {
