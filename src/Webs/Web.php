...
class Web
{
    ...
    */
    ...
    public static  function get_url_link($url)
    {
        if (!$url) {
            return "";
        }
    ...
    public static  function reset_path($str)
    {
        return str_replace('\\', '/', $str);
    }
    public static  function get_webroot($app_path)
    {
    ...
    public static  function get_headers_curl($url, $timeout=30, $depth=0, &$headers=array())
    {
    ...
    public static  function url_header($url)
    {
        ...
        if (isset($header[$location])) {
            ...
            } elseif (is_array($header[$location])  && count($header[$location])>0) {
     ...
     */
    public static  function curl_get_contents($url, $timeout=4)
    {
        $ch = curl_init();
     ...
     * @return array array
     */
    public static  function parse_url_query($url)
    {
        $arr = parse_url($url);
    ...
    public static  function parse_url_route()
    {
    ...
    //是否是windows
    public static  function client_is_windows()
    {
        static $is_windows;
    ...
    public static  function set_charset($charset="utf-8")
    {
